...
def parse_args():
    ...
    parser.add_argument('--gt_pth', default='dataset/spacenet/test/ann.json',help='ground truth path')
    ...
    parser.add_argument('--score_thr', default=0.3, type=float, help='score threshold')
